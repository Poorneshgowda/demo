...
public class PlanControllerTest {
	...
	public void givenPlanId_whenGetPlanById_thenReturnPlanObject() throws Exception {
		// given - precondition or setup
		long planId = 2L;
		Plan plan = new Plan(2, "Health Insurance Premium", 70000.0, "1999-10-10", "2020-10-10");

		given(planService.getPlanDetailsById(planId)).willReturn(plan);
	...
	public void givenPlanObject_whenCreatePlan_thenReturnSavedPlan() throws Exception {
		...
		// given - precondition or setup
		Plan plan = new Plan(1, null, 50000.0, "2022-11-11", "Pending");
